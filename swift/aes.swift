...
final public class AES {
    ...
    { /* unpack bytes from a word */
        var b:[UInt8]=[UInt8(a&0xff),UInt8((a>>8)&0xff),UInt8((a>>16)&0xff),UInt8((a>>24)&0xff)];
        return b;
    }
    ...
    { /* x.y= AntiLog(Log(x) + Log(y)) */
        ...
        var ix=Int(x)&0xff
        var iy=Int(y)&0xff
        var lx=Int(ltab[ix])&0xff
        var ly=Int(ltab[iy])&0xff
