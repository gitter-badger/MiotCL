...
int MPIN_CLIENT(int date,octet *CLIENT_ID,csprng *RNG,octet *X,int pin,octet *TOKEN,octet *SEC,octet *xID,octet *xCID,octet *PERMIT, int TimeValue, octet *Y)
{
  int rtn=0;
...
int MPIN_SERVER(int date,octet *HID,octet *HTID,octet *Y,octet *SST,octet *xID,octet *xCID,octet *SEC,octet *E,octet *F,octet *CID, int TimeValue)
{
  int rtn=0;
