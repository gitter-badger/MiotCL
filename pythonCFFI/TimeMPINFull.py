...
if __name__ == "__main__":
    ...
    if SINGLE_PASS:
        ...
        # Client MPIN
        ct1 = time_func('libmpin.MPIN_CLIENT(date, MPIN_ID, RNG, X, PIN, TOKEN, SEC, U, UT, TIME_PERMIT, TimeValue, Y)',nIter)
        ...
        # Server MPIN
        st1 = time_func('libmpin.MPIN_SERVER(date, HID, HTID, Y, SERVER_SECRET, U, UT, SEC, E, F, MPIN_ID, TimeValue)',nIter)
