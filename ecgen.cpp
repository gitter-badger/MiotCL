...
*/
	...
	cout << "/* MiotCL - ROM  C file for EC curves */" << endl << endl;
...
//		cout << "const BIG Monty=";output(0,WORDS[i],inverse(R,p),m); cout << ";" << endl;
	...
	cout << endl;
	cout << "Cut here -----------------------------------------------------------" << endl;
	cout << "/* MiotCL - ROM  Java file for 32-bit VM for EC curve */" << endl << endl;
...
//	cout << "public static final int[] Monty=";output(1,WORDS[1],inverse(R,p),m); cout << ";" << endl;
	...
	cout << endl;
	cout << "Cut here -----------------------------------------------------------" << endl;
	cout << "/* MiotCL - ROM  Java file for 64-bit VM for EC curve */" << endl << endl;
...
//	cout << "public static final long[] Monty=";output(3,WORDS[2],inverse(R,p),m); cout << ";" << endl;
	...
	cout << endl;
	cout << "Cut here -----------------------------------------------------------" << endl;
	cout << "/* MiotCL - ROM  Javascript file for EC curve - Weierstrass Only */" << endl << endl;
